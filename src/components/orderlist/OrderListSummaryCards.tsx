...
export const OrderListSummaryCards = ({ orders }: OrderListSummaryCardsProps) => {
  ...
  return (
    <section className="mt-4 grid gap-3 sm:grid-cols-3">
      <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-white/10 dark:bg-[#202a23]">
        <p className="text-xs text-stone-400">รายการในหน้านี้</p>
      ...
      <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-white/10 dark:bg-[#202a23]">
        <p className="text-xs text-stone-400">จัดส่งในหน้านี้</p>
        <p className="mt-1 text-2xl font-semibold text-stone-800 dark:text-stone-100">
          {deliveryCount} <span className="text-sm font-normal text-stone-400">รอบ</span>
        </p>
      </div>
      <div className="rounded-2xl border border-stone-200 bg-white p-4 dark:border-white/10 dark:bg-[#202a23]">
        <p className="text-xs text-stone-400">ยอดรวมในหน้านี้</p>
